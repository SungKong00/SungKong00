<img src="./assets/retro-v1/hero.jpg" alt="Noh Sung Been — 개발자와 Spring, Java Duke, Claude Clawd, Codex를 표현한 레트로 도트아트" width="100%">
...
<a href="https://github.com/TEAM-SSING/SSING-SERVER">
  <img src="./assets/retro-v1/ssing.jpg" alt="SSING — 스키 강습생과 강사를 연결하는 매칭 서비스" width="100%">
</a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <img src="./assets/retro-v1/equipment.jpg" alt="장비 대여 — 카메라, 삼각대, 장비 케이스 도트아트" width="100%">
      <h3>장비 대여 시스템</h3>
      <p>성균관대 영상학과의 장비·시설 대여 관리 시스템.</p>
      <p>학생의 신청부터 관리자 승인·수령·반납까지 처리하며, 중복 신청 조정과 부분 반납·양도를 다룹니다.</p>
      <p><code>TypeScript</code> <code>React</code> <code>PostgreSQL</code></p>
      <p>코드 비공개</p>
    </td>
    <td width="50%" valign="top">
      <img src="./assets/retro-v1/film-skku.jpg" alt="FILM-SKKU — 영사기, 필름, 티켓 도트아트" width="100%">
      <h3>FILM-SKKU</h3>
      <p>학교 구성원이 독립·고전 영화를 찾아보고 감상하는 모바일 시네마테크.</p>
      <p>기획전·영화 탐색·재생·기기 내 이어보기를 갖춘 프리뷰를 개발 중입니다.</p>
      <p><code>TypeScript</code> <code>React</code> <code>Hono</code> <code>Mux</code></p>
      <p>개발 중 · 코드 비공개</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="./assets/retro-v1/1km.jpg" alt="1KM — 릴스 체험과 길게 출력되는 종이를 표현한 도트아트" width="100%">
      <h3>1KM</h3>
      <p>릴스 형식의 영상을 탐색하고, 열어 본 영상 수가 종이의 길이로 출력되는 체험형 인터랙티브 아트.</p>
      <p>관람 화면과 출력 프로그램을 연결하고, 출력 중 연결이 끊기는 경우를 다뤘습니다.</p>
      <p><code>TypeScript</code> <code>React</code> <code>Python</code></p>
      <p>코드 비공개</p>
    </td>
    <td width="50%" valign="top">
      <img src="./assets/retro-v1/furniture.jpg" alt="가구 회사 홈페이지와 3D 견적기 — 가구, 온라인 쇼룸, 자 도트아트" width="100%">
      <h3>가구 회사 홈페이지 · 3D 견적기</h3>
      <p>가구 판매 회사의 홈페이지와 3D 견적기를 함께 만드는 프로젝트.</p>
      <p>현재는 특정 모델의 부품·배치를 검토하는 화면을 구현하고 있습니다. 회사 홈페이지와 실제 가격 산출 기능은 추가할 예정입니다.</p>
      <p><code>TypeScript</code> <code>Astro</code> <code>React</code></p>
      <p>개발 중 · 홈페이지 제작 예정 · 코드 비공개</p>
    </td>
  </tr>
</table>
...
<picture>
  ...
  <img alt="SungKong00의 GitHub 기여 활동을 3D로 표현한 달력" src="./profile-3d-contrib/profile-green-animate.svg" width="100%">
</picture>
